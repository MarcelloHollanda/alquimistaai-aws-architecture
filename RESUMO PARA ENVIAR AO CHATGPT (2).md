...
5\. \`frontend/src/lib/constants.ts\` \- **\*\*ATUALIZADO\*\*** (novas rotas \`INSTITUTIONAL\` e \`PUBLIC\_BILLING\`)  
...
5\. ✅ Atualização de \`lib/constants.ts\` com novas rotas \`INSTITUTIONAL\` e \`PUBLIC\_BILLING\`  
...
**\*\*Última atualização:\*\*** 24/11/2024 14:50    
**\*\*Status:\*\*** ✅ **\*\*Conflito de rotas paralelas corrigido \- Aguardando validação manual\*\***
...
**\*\*Modificados:\*\***  
\- \`frontend/src/lib/constants.ts\` \- Adicionada constante \`DASHBOARD\_DISPARO\_AGENDA\`  
