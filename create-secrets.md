...
*.EXAMPLE*  
    ...
    *Executa o script com valores interativos*
...
$emailEndpoint \= **Get-SecretInput** "   Endpoint Email" "https://api.email.example.com"  
$emailApiKey \= **Get-SecretInput** "   API Key Email" "email-test-key-456"

*\# Calendar*  
**Write-Host** ""  
**Write-Host** "3\. MCP Calendar" \-ForegroundColor Cyan  
$calendarEndpoint \= **Get-SecretInput** "   Endpoint Calendar" "https://api.calendar.example.com"  
$calendarApiKey \= **Get-SecretInput** "   API Key Calendar" "calendar-test-key-789"  
...
$whatsappSecretValue \= @{  
    ...
    api\_key \= $whatsappApiKey  
} | **ConvertTo-Json** \-Compress

$results.whatsapp \= **New-OrUpdateSecret** \`  
    \-SecretName $whatsappSecretName \`  
    \-Description "Credenciais MCP WhatsApp para Micro Agente de Disparo e Agendamento" \`  
...
$emailSecretValue \= @{  
    ...
    api\_key \= $emailApiKey  
} | **ConvertTo-Json** \-Compress

$results.email \= **New-OrUpdateSecret** \`  
    \-SecretName $emailSecretName \`  
    \-Description "Credenciais MCP Email para Micro Agente de Disparo e Agendamento" \`  
...
$calendarSecretValue \= @{  
    ...
    api\_key \= $calendarApiKey  
    calendar\_id \= $calendarId  
} | **ConvertTo-Json** \-Compress

$results.calendar \= **New-OrUpdateSecret** \`  
    \-SecretName $calendarSecretName \`  
    \-Description "Credenciais MCP Calendar para Micro Agente de Disparo e Agendamento" \`  
    \-SecretValue $calendarSecretValue \`  
    \-Region $Region
...
**Write-Host** "Secrets processados: $successCount/$totalCount" \-ForegroundColor $(if ($successCount \-eq $totalCount) { "Green" } else { "Yellow" })  
**Write-Host** ""
...
**Write-Host** "  aws secretsmanager put-secret-value \--region $Region \--secret-id NOME\_DO\_SECRET \--secret-string '{""endpoint"":""URL"",""api\_key"":""KEY""}'" \-ForegroundColor Gray  
**Write-Host** ""
