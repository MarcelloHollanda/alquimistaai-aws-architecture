 ...
 *
 * Componente de erro específico para o grupo de rotas (dashboard).
 * Captura erros que ocorrem nas páginas do dashboard.
 */
export default function DashboardError({ error, reset }: ErrorProps) {
  useEffect(() => {
    // Log do erro para debug
    console.error('[DashboardError] Erro capturado:', error);
  }, [error]);
